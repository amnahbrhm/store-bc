...
mongoose.connect("mongodb://devopstore:amn%401234@127.0.0.1:27017/?directConnection=true&authSource=admin&appName=mongosh+2.0.0").then(() => console.log("Db Connected!"));
